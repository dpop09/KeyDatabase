...
function Home() {
    ...
    const { accessId, setAccessId, setKeyData } = useContext(AuthContext)
    ...
    return (
        <>
            {accessId === "Unauthorized" ? ( // display an unauthorized access message
                <div id="Keys-div-unauthorized">
                    <h1 id="Keys-h1-unauthorized">Unauthorized Access</h1>
                    <p id="Keys-p-unauthorized">Contact the building manager to request access.</p>
                </div>
            ) : ( // otherwise, display the keys page
                <>
                    <NavBar />
